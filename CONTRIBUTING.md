# Contributing to WXMON

We're thrilled that you're interested in contributing to WXMON! This document provides a set of guidelines for contributing to WXMON. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
For those wishing to contribute to WXMON, please make your mods to the **"wxmon.sh"** file under the "develop" branch. For more info, please see below:
